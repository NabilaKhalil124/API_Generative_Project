...
namespace LLMUnitySamples
{
    public static class Functions
    {
        ...
        //return a random time in the format of "HH:MM"
    ...
    public class FunctionCalling : MonoBehaviour
    {
        ...
        //grammar for the function calling Creates a grammar rule that allows the AI to choose between available function names.
